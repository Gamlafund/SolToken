      ...
      <>
        {walletConnected ? (
          ...
          <p>
            ...
            <li>Step 2: Mint More 100 tokens: <button disabled={loading || supplyCapped} onClick={mintAgainHelper}>Mint Again</button></li>
            </p>
          <p>              
              <li>Transfer tokens to friends: <button disabled={loading || supplyCapped} onClick={transferTokenHelper}>Transfer 10 tokens</button></li>
              <li>Cap token supply: <button disabled={loading || supplyCapped} onClick={capSupplyHelper}>Cap token supply</button></li>
          </p>
          </>
        ) : (
          <></>
